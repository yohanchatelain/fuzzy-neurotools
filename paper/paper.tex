...
\tristan{To be discussed with Ali, this paragraph explains what was done but not 
the purpose or the result of it.}
  ...
  \begin{figure*}[ht]
    \fbox{\begin{minipage}{\dimexpr \textwidth-2\fboxsep-2\fboxrule}
      ...
      \caption{
        ...
        voxels where the BT/WT ration is in (0.5, 2).}
