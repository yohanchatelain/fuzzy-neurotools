...
We also computed t-test statistics to examine differences in WT variability between tools.
Results show that AFNI was generated the most variability in WT among the three tools with 
the high t-value 39.6 between \fslafni samples and 65.5 between \afnispm samples, and p-value $< 0.05$.
\ali{I'm checking this with Greg}.
...
Although BT variability was an order of magnitude higher than WT variability on average,
