...
indicated voxels with similar magnitude of BT and WT variations were uniformly distributed across the brain.
  ...
  Summary statistics for the subject-level unthresholded t-statistics are reported in Table~\ref{table:unthresh-maps-subjects}.
  Overall, results represent similar findings with group-level t-statistics between WT and BT variations.
